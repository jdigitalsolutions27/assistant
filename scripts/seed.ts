...
async function upsertPlaybooks(categoryMap: Map<string, string>): Promise<void> {
  const playbooks = [
    {
      name: "Dental Rebuild Starter",
      category: "Dental Clinic",
      language: "English",
      tone: "Value-Focused",
      angle: "booking",
      min_quality_score: 55,
      daily_send_target: 18,
      follow_up_days: 3,
      notes: "Best for clinics with an existing site or Facebook page but weak inquiry-to-booking flow.",
    },
    {
      name: "Construction Website Rebuild",
      ...
      follow_up_days: 4,
      notes: "Target contractors with outdated sites, weak quote forms, or poor mobile presentation.",
    },
    {
      name: "Home Services Rebuild Sprint",
      ...
      follow_up_days: 3,
      notes: "Ideal for plumbers, electricians, aircon, and repair businesses that rely on phone and Facebook inquiries.",
    },
    {
      name: "Launch Offer for No-Website Leads",
      category: "Hotel",
      language: "English",
      tone: "Soft",
      angle: "booking",
      ...
      daily_send_target: 20,
      follow_up_days: 3,
      notes: "Use this playbook when prospecting launch-mode leads that still depend only on Facebook or listings.",
    },
  ] as const;
